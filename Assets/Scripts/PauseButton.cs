...
public class PauseButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        resizableObject.transform.localScale = new Vector3(1.1f, 1.1f, 1f);
    }
